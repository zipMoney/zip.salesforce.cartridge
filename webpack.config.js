...
module.exports = [{
    ...
    name: 'js',
    entry: {
        zippayments: path.join(__dirname, cartridgePath + 'client/default/js/client.js')
    },
    output: {
    ...
    name: 'scss',
    entry: {
        zippayments: path.join(__dirname, cartridgePath + 'client/default/scss/client.scss')
    },
    output: {
