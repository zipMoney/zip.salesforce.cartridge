...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        ...
        if (paymentInstrument.paymentMethod === 'CREDIT_CARD') {
        ...
        } else if (ZipHelpers.isPaymentMethodZip(paymentInstrument.paymentMethod)) {
            ...
            results.amountFormatted = dw.util.StringUtils.formatMoney(new dw.value.Money(transaction.amount.value, transaction.amount.currencyCode));
