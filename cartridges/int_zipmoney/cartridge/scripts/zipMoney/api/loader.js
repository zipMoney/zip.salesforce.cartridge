...
var APIClient = require('~/cartridge/scripts/zipMoney/api/client');
...
var Loader = {
    ...
    loadCreateCheckoutRequestBuilder: function (lineItemCtnr, customerTokenizationRequired) {
        var ShopperBuilder = require('~/cartridge/scripts/zipMoney/api/builder/shopper');
        var OrderBuilder = require('~/cartridge/scripts/zipMoney/api/builder/order');
        var CheckoutRequestBuilder = require('~/cartridge/scripts/zipMoney/api/builder/request/createCheckout');
        var OrderShippingBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderShipping');
        var OrderItemsBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderItems');
        var ShippingAddressBuilder = require('~/cartridge/scripts/zipMoney/api/builder/shippingAddress');
        var BillingAddressBuilder = require('~/cartridge/scripts/zipMoney/api/builder/billingAddress');
    ...
    loadCreateChargeRequestBuilder: function () {
        var Builder = require('~/cartridge/scripts/zipMoney/api/builder/request/createCharge');

        return new Builder();
    },
    loadCaptureChargeRequestBuilder: function () {
        var Builder = require('~/cartridge/scripts/zipMoney/api/builder/request/captureCharge');

        return new Builder();
    },
    loadCreateTokenRequestBuilder: function () {
        var Builder = require('~/cartridge/scripts/zipMoney/api/builder/request/createToken');

        return new Builder();
    },
    loadCreateRefundRequestBuilder: function () {
        var Builder = require('~/cartridge/scripts/zipMoney/api/builder/request/createRefund');

        return new Builder();
    },
    loadCreateCancelRequestBuilder: function () {
        var Builder = require('~/cartridge/scripts/zipMoney/api/builder/request/createCancel');

        return new Builder();
    },
    loadShippingOrderItemBuilder: function (shipment) {
        var OrderItemBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderItem/shipping');
    ...
    loadAdjustmentOrderItemBuilder: function (adj) {
        var OrderItemBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderItem/discount');
    ...
    loadTaxOrderItemBuilder: function (tax) {
        var OrderItemBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderItem/tax');
    ...
    loadSkuOrderItemBuilder: function (lineItem) {
        var OrderItemBuilder = require('~/cartridge/scripts/zipMoney/api/builder/orderItem/sku');
