...
var ZipPaymentTransaction = {
    ...
    reflectChargeAuthorized: function (paymentTransaction, chargeResult, autoCapture) {
        ...
        paymentTransaction.custom.isZipAutoCapture = autoCapture;
        paymentTransaction.custom.ZipChargeId = chargeResult.id;
        paymentTransaction.custom.ZipReceiptNumber = chargeResult.receipt_number;
        paymentTransaction.setAmount(moneyAmount);
